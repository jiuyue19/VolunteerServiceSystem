...
('user_management', '用户管理', 'MENU', 0, NULL, 'User', 2, '用户管理模块'),
('activity_management', '活动管理', 'MENU', 0, NULL, 'Calendar', 3, '活动管理模块'),
('audit_management', '志愿审核', 'MENU', 0, NULL, 'Document', 4, '志愿审核模块'),
('order_management', '订单管理', 'MENU', 0, NULL, 'ShoppingCart', 5, '订单管理模块'),
('blockchain_management', '区块链管理', 'MENU', 0, NULL, 'Link', 6, '区块链管理模块'),
...
('post_categories', '帖子分类', 'MENU', 3, '/admin/post-categories', NULL, 34, '帖子分类管理'),
...
-- 区块链管理子菜单
('blockchain_query', '区块链服务查询', 'MENU', 6, '/admin/blockchain-query', NULL, 61, '区块链服务查询'),
('blockchain', '区块链证书', 'MENU', 6, '/admin/blockchain', NULL, 62, '区块链证书管理'),
('certificate_library', '证书库管理', 'MENU', 6, '/admin/certificate-library', NULL, 63, '证书库管理'),

-- 权限管理菜单（仅超级管理员可见）
('permission_management', '权限管理', 'MENU', 0, '/admin/permissions', 'Lock', 7, '管理员权限配置');
