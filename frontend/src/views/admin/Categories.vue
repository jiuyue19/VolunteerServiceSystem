...
import { getCategoryList, addCategory, updateCategory, deleteCategory, batchDeleteCategory } from '@/api/category'
...
const handleDelete = (row) => {
  ElMessageBox.confirm('确定要删除该活动分类吗？', '提示', {
...
const handleBatchDelete = () => {
  ElMessageBox.confirm(`确定要删除选中的 ${selectedIds.value.length} 个活动分类吗？`, '提示', {
    confirmButtonText: '确定',
    cancelButtonText: '取消',
    type: 'warning'
  }).then(async () => {
